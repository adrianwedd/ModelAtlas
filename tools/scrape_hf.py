            ...
            try:
                ...
                try:
                    ...
                    if model_card.data:
                        ...
                        # This part might need more specific mapping based on common model card structures
                                    ...
                                    for result in item["results"]:
                                        if "metrics" in result:
                                            for metric in result["metrics"]:
                                                # Example: Extracting benchmark scores
                ...
                model_file_path = os.path.join(model_output_dir, f"{model_id.replace('/', '_')}.json")
